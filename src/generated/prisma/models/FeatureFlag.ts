...
export type FeatureFlagWhereInput = {
  ...
  feature?: Prisma.EnumFeatureFilter<"FeatureFlag"> | $Enums.Feature
...
export type FeatureFlagScalarWhereWithAggregatesInput = {
  ...
  feature?: Prisma.EnumFeatureWithAggregatesFilter<"FeatureFlag"> | $Enums.Feature
...
export type FeatureFlagOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "feature" | "isEnabled" | "updatedAt", ExtArgs["result"]["featureFlag"]>
...
export interface FeatureFlagDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more FeatureFlags that matches the filter.
   * @param {FeatureFlagFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const featureFlag = await prisma.featureFlag.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.FeatureFlagFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a FeatureFlag.
   * @param {FeatureFlagAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const featureFlag = await prisma.featureFlag.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.FeatureFlagAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
...
export interface FeatureFlagFieldRefs {
  ...
  readonly feature: Prisma.FieldRef<"FeatureFlag", 'Feature'>
 ...
 * FeatureFlag findRaw
 */
export type FeatureFlagFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
...
/**
 * FeatureFlag aggregateRaw
 */
export type FeatureFlagAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
